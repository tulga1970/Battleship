...
/*jslint         browser : true, continue : true,
  ...
  white  : true
*/
/*global $, battleship, getComputedStyle */

battleship.util_b = (function () {
  'use strict';
  ...
  var
    ...
    decodeHtml,  encodeHtml, getEmSize, getRandRgb, getRandRgbBrighter, getRandHex, showInfoMessage;
  ...
  getRandRgb = function (){
    ...
    for ( i = 0; i < 3; i++ ){
      rgb_list.push( Math.floor( Math.random() * 128));
    }
    return 'rgb(' + rgb_list.join(',') + ')';
  };

  getRandRgbBrighter = function (){
    return 'rgb(' + Math.floor( Math.random() * 128) + ', 128, 128)';
  };
  ...
  return {
    ...
    getRandRgbBrighter : getRandRgbBrighter,
    getRandHex : getRandHex,
  };
  //------------------- END PUBLIC METHODS ---------------------
}());
